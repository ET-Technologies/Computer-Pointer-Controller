...
class Facial_Landmarks:
    ...
    def predict(self, face_cropped):
        ...
        print("--------")
        print("Start inference Facial_Landmarks")
        log.info("Start inference Facial_Landmarks")
        # Pre-process the image
        preprocessed_image = self.preprocess_input(face_cropped.copy())
        ...
        h, w = face_cropped.shape[0], face_cropped.shape[1]
        ...
        left_eye_frame_cropped = face_cropped[self.left_eye_y_min:self.left_eye_y_max, self.left_eye_x_min :self.left_eye_x_max]
        right_eye_frame_cropped = face_cropped[self.right_eye_y_min:self.right_eye_y_max, self.right_eye_x_min :self.right_eye_x_max]
    ...
    def preprocess_output(self, outputs):
        ...
        self.left_eye_coordinates_x = output[0][0][0]
        self.left_eye_coordinates_y = output[1][0][0]

        self.right_eye_coordinates_x = output[2][0][0]
        self.right_eye_coordinates_y = output[3][0][0]

    
    def preprocess_output_eeS(self, frame):
